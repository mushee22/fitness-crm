            ...
            <div className="flex items-start gap-4">
                ...
                <div>
                    ...
                    <div className="flex items-center gap-2 mt-1 text-slate-500">
                        ...
                        <span>•</span>
                        <span>{format(new Date(attendance.created_at), 'MMMM d, yyyy')}</span>
                    </div>
                </div>
            </div>
                        ...
                        <div className="flex items-start gap-4 p-4 rounded-lg bg-slate-50 border border-slate-100">
                            ...
                            <div className="flex-1 min-w-0">
                                ...
                                <p className="text-sm text-slate-500">
                                    {attendance.fitness_session?.start_time ? format(new Date(attendance.fitness_session.start_time), 'h:mm a') : 'N/A'}
                                    {' - '}
                                    {attendance.fitness_session?.end_time ? format(new Date(attendance.fitness_session.end_time), 'h:mm a') : 'N/A'}
                                </p>
                            </div>
                        </div>
                    </CardContent>
                    ...
                    <CardContent className="space-y-6">
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            ...
                            <div className="p-3 bg-slate-50 rounded-lg border border-slate-100">
                                ...
                                <p className="font-semibold text-slate-900">
                                    {attendance.left_at ? format(new Date(attendance.left_at), 'h:mm a') : '-'}
                                </p>
                            </div>
                        </div>
